<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CustomQueryInReportDesigner.Default" %>
...
<body>
    ...
    <div>
            ...
            <PanelCollection>
                <dx:PanelContent runat="server">
                    <dx:ASPxReportDesigner ID="reportDesigner" runat="server" ClientInstanceName="reportDesigner"
                        ...
                        <MenuItems>
                            <cc1:ClientControlsMenuItem Text="Run Report DataSource Editor" ImageClassName="DataSourceWizardImage"
        ...
        <dx:ASPxPopupControl ID="popupWizard" runat="server" ClientInstanceName="popupWizard"
            CloseAction="CloseButton" CloseAnimationType="Slide" HeaderText="Report DataSource Editor"
